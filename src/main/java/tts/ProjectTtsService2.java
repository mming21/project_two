...
@Service
public class ProjectTtsService2 {

	// public static void main(String[] args) throws IOException 
	 public String main(String file) throws IOException {
		 String tempname="";
	     ...
	     try {
	         ...
	         if(responseCode==200) { // 정상 호출
	            ...
	            // SimpleDateFormat sf = new SimpleDateFormat("yyyyMMddHHmmss");
	             tempname = "test";//sf.format(new Date());
	            
	             //tempname = "test";
	             
	             File f = new File("C:\\Users\\knifejo\\Desktop\\프로젝트\\text파일/" + tempname + ".mp3");
	             f.createNewFile();
