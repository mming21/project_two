...
@Service
public class NaverTTSService implements NaverService {

	@Override  //필수
	public String test(String file) {
		 return test(file, "nsinu");
	...
	public String test(String file, String speaker) {
	    ...
	    String clientSecret = "VVeGuwAlvJztUI99JWgHVbeqbwkOmtQEcve3Umd3";//애플리케이션 클라이언트 시크릿값";
	     ...
	     try {
	         ...
	         text = "";
	         String textfile = "C:/Users/USER/Desktop/TTS/CHA CHA CHA.txt";
	       ...
	       //FileWriter(텍스트)-stt(텍스트를 파일로 저장) , 
	         ...
	         if(responseCode==200) { // 정상 호출
	            ...
	            tempname =  sf.format(new Date());
	             ...
	             File f = new File("C:/Users/USER/Desktop/TTS/" + tempname + ".mp3");
	             f.createNewFile();
