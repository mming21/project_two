	...
	<hr class="divider" />
		<div id="studyInput">
			<form action="/savestudy" method="post">	
				...
				<div>
				    <input class="textarea" type="text" name="study_id" style="width:300px;" placeholder="study_id"><br><br>
				</div>
				<div>
				    <input class="textarea" type="text" name="title" style="width:300px;" placeholder="title"><br><br>
				</div>
				<div>
				    <input class="textarea" type="text" name="study_memo1" style="width:300px; height:100px;" placeholder="memo1"> <br><br><br>
				</div>
				<div>
				    <input class="textarea" type="text" name="study_memo2" style="width:300px; height:100px;" placeholder="memo2" > <br><br><br>
				</div>
				<div>
