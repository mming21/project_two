...
<form action="insertmember" method="post" name="userInfo" onsubmit="return checkValue()">
	...
	EMAIL<br><input id="email" type="email" name="email" maxlength="50" placeholder="name@example.com">
	<!--
	EMAIL<br><input id= email1 type="text" name="email" maxlength="50"><span>@</span>
	 <input type="hidden" name="email" value="@">
	<input id="email2" name="email" list="domains" placeholder="Domain"style="width:75px;" >
	<datalist id="domains" name = "domains">
